Feature: BookingTest
  ...
  Scenario Outline: Successful Register
    ...
    Scenario Outline: Booking a hotel
      ...
      Then Select hotel page should open "<location>", "<hotel>", "<room_type>", "<NOR>", "<CID>", "<COD>"
     ...
     And user clicks book now
      ...
      Examples:
        ...
        |Sydney  |Hotel Creek|Standard|1 - One | 29/03/2024 |30/03/2024  |1 - One |1 - One|Tiisetso  |Madi     |7 6th avenue|4444555566667777|American Express|March|2029|333|

      Scenario: Checking the itinerary booked
        Given User is logged in
